...
// client.get('products/299461', async(err, result)=>{
//     if(err){
//         console.log(err)
//     }
//     else{
...
var conString = "postgres://hyibbaxa:GEMq3xhistrekIfquhdCAjBwA87aqu9w@rajje.db.elephantsql.com/hyibbaxa" //Can be found in the Details page
var client = new pg.Client(conString);
client.connect(function(err) {
  if(err) {
    return console.error('could not connect to postgres', err);
  }
  client.query(`CREATE TABLE example (
    ...
    console.log(result)    // >> output: 2018-08-23T14:02:57.117Z
    client.end();
  });
});
